...
class User(models.Model):
    ...
    def __str__(self):
        return f'le nom est {self.nom}, le prenom est {self.prenom}, email est {self.email}'


class Etudiant(User):
    groupe = models.CharField(max_length=30)
    def __str__(self):
        return f'le nom est {self.nom}, le prenom est {self.prenom}, email est {self.email},le groupe est {self.groupe}'
...
class Projet(models.Model):
    ...
    temps_alloue_createur = models.IntegerField('Temps alloue',
